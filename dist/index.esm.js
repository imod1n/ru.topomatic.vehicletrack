import { defineComponent, ref, reactive, computed, onMounted, openBlock, createElementBlock, createElementVNode, withDirectives, createStaticVNode, vModelSelect, normalizeClass, vModelText, vModelCheckbox, createTextVNode, toDisplayString, createCommentVNode } from "vue";
...
const _sfc_main = defineComponent({
  ...
  setup(props) {
    const selectedPreset = ref("truck_16m");
    const isCalculating = ref(false);
    const hasResult = ref(false);
    const statusMessage = ref("");
    const statusClass = ref("");
    const vehicle = reactive({ ...VEHICLE_PRESETS.truck_16m });
    const options = reactive({
      showOuterContour: true,
      showInnerContour: true,
      corridorColor: "#FF6600"
    });
    const alignmentInfo = ref(null);
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", _hoisted_1, [
    _cache[28] || (_cache[28] = createElementVNode("h3", { class: "panel-title" }, "🚛 Коридор движения ТС", -1)),
    createElementVNode("div", _hoisted_2, [
      _cache[13] || (_cache[13] = createElementVNode("label", null, "Тип транспортного средства", -1)),
    ...
    createElementVNode("div", {
      ...
      createElementVNode("div", _hoisted_5, [
        _cache[15] || (_cache[15] = createElementVNode("label", null, "Ширина колеи (м)", -1)),
        withDirectives(createElementVNode("input", {
          type: "number",
      ...
      createElementVNode("div", _hoisted_7, [
        _cache[16] || (_cache[16] = createElementVNode("label", null, "Передний свес (м)", -1)),
        withDirectives(createElementVNode("input", {
          type: "number",
      ...
      createElementVNode("div", _hoisted_9, [
        _cache[17] || (_cache[17] = createElementVNode("label", null, "Задний свес (м)", -1)),
        withDirectives(createElementVNode("input", {
          type: "number",
      ...
      createElementVNode("div", _hoisted_11, [
        _cache[18] || (_cache[18] = createElementVNode("label", null, "Мин. радиус поворота (м)", -1)),
        withDirectives(createElementVNode("input", {
          type: "number",
    ...
    createElementVNode("div", _hoisted_13, [
      createElementVNode("label", _hoisted_14, [
        withDirectives(createElementVNode("input", {
          ...
          [vModelCheckbox, _ctx.options.showOuterContour]
        ]),
        _cache[19] || (_cache[19] = createTextVNode(" Показать внешний контур ", -1))
      ]),
      createElementVNode("label", _hoisted_15, [
        withDirectives(createElementVNode("input", {
          ...
          [vModelCheckbox, _ctx.options.showInnerContour]
        ]),
        _cache[20] || (_cache[20] = createTextVNode(" Показать внутренний контур ", -1))
      ])
    ]),
    createElementVNode("div", _hoisted_16, [
      _cache[21] || (_cache[21] = createElementVNode("label", null, "Цвет коридора", -1)),
      withDirectives(createElementVNode("input", {
        type: "color",
        "onUpdate:modelValue": _cache[9] || (_cache[9] = ($event) => _ctx.options.corridorColor = $event)
      }, null, 512), [
        [vModelText, _ctx.options.corridorColor]
      ])
    ]),
    _ctx.alignmentInfo ? (openBlock(), createElementBlock("div", _hoisted_17, [
      _cache[22] || (_cache[22] = createElementVNode("strong", null, "Трасса:", -1)),
      createTextVNode(" " + toDisplayString(_ctx.alignmentInfo.name), 1),
      _cache[23] || (_cache[23] = createElementVNode("br", null, null, -1)),
      _cache[24] || (_cache[24] = createElementVNode("strong", null, "Длина:", -1)),
      createTextVNode(" " + toDisplayString(_ctx.alignmentInfo.length.toFixed(1)) + " м ", 1)
    ])) : (openBlock(), createElementBlock("div", _hoisted_18, " ⚠️ Выберите трассу в модели ")),
    _ctx.calcPreview ? (openBlock(), createElementBlock("div", _hoisted_19, [
      createElementVNode("div", _hoisted_20, [
        _cache[25] || (_cache[25] = createElementVNode("span", null, "Ширина коридора (прямая):", -1)),
        createElementVNode("strong", null, toDisplayString(_ctx.calcPreview.straightWidth.toFixed(2)) + " м", 1)
      ]),
      createElementVNode("div", _hoisted_21, [
        _cache[26] || (_cache[26] = createElementVNode("span", null, "Внешний радиус поворота:", -1)),
        createElementVNode("strong", null, toDisplayString(_ctx.calcPreview.outerRadius.toFixed(2)) + " м", 1)
      ]),
      createElementVNode("div", _hoisted_22, [
        _cache[27] || (_cache[27] = createElementVNode("span", null, "Внутренний радиус поворота:", -1)),
        createElementVNode("strong", null, toDisplayString(_ctx.calcPreview.innerRadius.toFixed(2)) + " м", 1)
      ])
    ...
    createElementVNode("div", _hoisted_23, [
      ...
      }, toDisplayString(_ctx.isCalculating ? "⏳ Расчёт..." : "▶ Рассчитать коридор"), 9, _hoisted_24),
      createElementVNode("button", {
        class: "btn-secondary",
    ...
    _ctx.statusMessage ? (openBlock(), createElementBlock("div", {
      key: 3,
      class: normalizeClass(["status", _ctx.statusClass])
    }, toDisplayString(_ctx.statusMessage), 3)) : createCommentVNode("", true)
  ]);
}
...
export {
  VEHICLE_PRESETS,
  VehicleTrackCalculator,
  VehicleTrackPlugin,
  VehicleTrackPlugin as default,
  parseIfcAlignment
};
